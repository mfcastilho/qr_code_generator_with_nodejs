...
async function handleSubmit(e) {
    ...
    if (url) try {
        const response = await (0, _axiosDefault.default).post("http://localhost:5050/create-qrcode", {
            url: url.value
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8bDoD","3cYfC"], "3cYfC", "parcelRequire10c2")
